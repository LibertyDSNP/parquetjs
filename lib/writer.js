  ...
  writeBloomFilters(_rowGroups) {
    ...
    rowGroups.forEach(group => {
      group.columns.forEach(column => {
        ...
        const filterBlocks = this.bloomFilters[columnName];

        const serializedBloomFilterData = bloomFilterWriter.serializeBloomFilterData(filterBlocks);

        bloomFilterWriter.setBloomFilterOffset(column, this.offset);
