...
class ParquetReader {
  ...
  getBloomFiltersFor(columnNames) {
    const columnChunkDataCollection = this.envelopeReader.getAllColumnChunkDataFor(columnNames);
    const offsetsByColumn = siftAllOffsets(columnChunkDataCollection);
